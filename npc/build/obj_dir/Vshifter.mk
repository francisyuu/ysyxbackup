...
default: /home/francisyuu/Documents/ysyx22050133/ysyx-workbench/npc/build/shifter
...
shifter.o: /home/francisyuu/Documents/ysyx22050133/ysyx-workbench/npc/csrc/shifter.cpp
	$(OBJCACHE) $(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
/home/francisyuu/Documents/ysyx22050133/ysyx-workbench/npc/build/shifter: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a $(VM_HIER_LIBS)
