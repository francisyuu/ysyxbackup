...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("000000? ????? ????? 101 ????? 00100 11", srli        , I, R(dest) = src1>>(unsigned int)BITS(imm,5,0));
  ...
  INSTPAT("0100000 ????? ????? 101 ????? 00110 11", sraiw       , I, R(dest) = SEXT(BITS(src1>>BITS(imm,4,0),31,0),32));
